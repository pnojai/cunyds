...
- One: `r q_leo_meth1 * 100`%
- Two: `r q_leo_meth2 * 100`%
...
- One: `r q_mary_meth1 * 100`%
- Two: `r q_mary_meth2 * 100`%
...
- Area under the curve within 1 standard deviation: `r heights_area_1sd * 100`%.
- Within 2 standard deviations: `r heights_area_2sd * 100`%.
- Within 3 standard deviations: `r heights_area_3sd * 100`%.
...
(a) What is the probability that the 10th transistor produced is the first with a defect? **`r ans_4_14a`**
(b) What is the probability that the machine produces no defective transistors in a batch of 100? **`r ans_4_14b`**
(c) On average, how many transistors would you expect to be produced before the first with a defect? **The first defect, on average, would appear on transister number `r ans_4_14c1`. The way this question is worded, the answer is `r ans_4_14c1 - 1` transistors would, on average, be produced without a defect, with a defect appearing on number `r ans_4_14c1`.** What is the standard deviation? **`r ans_4_14c2`.**
(d) Another machine that also produces transistors has a 5% defective rate where each transistor
is produced independent of the others. On average how many transistors would you expect to be produced with this machine before the first with a defect? **`r ans_4_14d1 - 1` without a defect until the first one, appearing on average with number `r ans_4_14d1`.** What is the standard deviation? **`r ans_4_14d2`.**
