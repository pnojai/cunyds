...
The typical size is `r round(samp_mean)` square feet. I interpret typical to mean the statistical mean.
...
- Confidence interval: `r c(lower, upper)`
- Population mean: `r mean(population)`
- Confidence interval captures true averge: `r in_ci`
