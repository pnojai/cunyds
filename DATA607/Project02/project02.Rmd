...
### Validate filters
The report presents totals for both sexes. My organization of the data removes summary rows. I validated that I removed the necessary rows and no more than that. I compare the world totals by year from my cleaned data set against the world totals in the report and found no differences.
