...
The CSV report is built from the data frame, `player_df` and it is sampled below. The location of the file is: `r str_c(assign_dir, "/player.csv")`.
...
My debugging work appears in `debug.R`. The results will appear different, now that I've fixed the bug, but the script documents my investigative approach.
